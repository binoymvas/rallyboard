...
tests_list = [
'tempest.api.image.v2.test_images_member.ImagesMemberTest.test_get_image_members_schema', 'tempest.api.identity.admin.v2.test_tenants.TenantsTestJSON.test_tenant_update_name', 'tempest.api.identity.admin.v2.test_roles_negative.RolesNegativeTestJSON.test_remove_user_role_non_existent_role', 'tempest.api.identity.admin.v3.test_trusts.TrustsV3TestJSON.test_trust_impersonate', 'tempest.api.identity.admin.v3.test_roles.RolesV3TestJSON.test_list_roles',
